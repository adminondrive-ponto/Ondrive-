...
Repasses (sócios): ${realData.totalRepassesFormatado ?? realData.totalRepasses}

Lucro atual (30 dias): ${realData.lucro30DiasFormatado ?? realData.lucro30Dias}
Lucro em 60 dias: ${realData.lucro60DiasFormatado ?? realData.lucro60Dias}
Lucro em 90 dias: ${realData.lucro90DiasFormatado ?? realData.lucro90Dias}

Cálculo usado:
Lucro atual = (Aluguel - Despesas) * % ADM
Lucro 60 dias = lucro atual + 1 mês futuro
Lucro 90 dias = lucro atual + 2 meses futuros`,
          },
        ]);
